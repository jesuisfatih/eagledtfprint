...
exports.ShopifyCustomersModule = ShopifyCustomersModule = __decorate([
    (0, common_1.Module)({
        controllers: [shopify_customers_controller_1.ShopifyCustomersController],
        providers: [shopify_customers_service_1.ShopifyCustomersService],
        exports: [shopify_customers_service_1.ShopifyCustomersService],
    })
